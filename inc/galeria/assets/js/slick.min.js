...
jQuery(document).on('click','.each-galeria-brasa .navegacao-slider a',function(e){
	e.preventDefault();
	jQuery('.each-galeria-brasa .loader').fadeIn()
	jQuery('#main-slide img').addClass('blur')
	url = jQuery(this).attr('data-src');
	jQuery('#main-slide img').attr('src', url);
	jQuery('#main-slide img[src="'+url+'"]').on('load',function(e){
		jQuery('.each-galeria-brasa .loader').fadeOut();
		jQuery('#main-slide img').removeClass('blur');
	});
